        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header border-0">
                            <h3 class="card-title">Informations cartes virtuelle</h3>
                        </div>
                        <div class="card-body table-responsive">
                            ...
                            <form action="/card/infos/update" id="form-add" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="add-role">Modifier</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header border-0">
                            <h3 class="card-title">Services des applications</h3>
                        </div>
                        <div class="card-body table-responsive">
                            <button type="button" class="btn waves-effect waves-light btn-primary" data-toggle="modal" data-target="#add-gamme"> Ajouter un module </button>
                            <br>
                            <br>
                                ...
                                <tbody>
                                    @foreach ($services as $item)
                                        <tr>
                                            ...
                                            <td>@if($item->status == 1) Active @else Desactivate @endif</td>
                                            <td>
                                                <div class="btn-group">
