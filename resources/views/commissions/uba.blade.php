    ...
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header border-0">
                <h3 class="card-title">Compte commission UBA</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <i class="fas fa-wallet fa-2x"></i>
                    &nbsp;&nbsp;&nbsp;
                    <h3>{{ $compteUba->solde }} XOF</h3>
                </div>
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <table class="table table-bordered table-striped example1">
                        ...
                        <tr>
                            <th>
                                <div class="form-check">
                                    <input style="margin-top:-15px" class="form-check-input" type="checkbox" id="checkAll">
                                </div>
                            </th>
                            <th>Date</th>
                            <th>Reference BCV</th>
                    ...
                    <tbody>
                        @foreach ($compteUbaOperations as $item)
                            <tr>
                                <td>
                                    <div class="form-check">
