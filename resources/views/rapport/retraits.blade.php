                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control daterange" id="periode" name="periode" placeholder="ID de la premiere carte">
                                        </div>
                                    </div>
                    ...
                    success: function(data){
                        ...
                        $(".exportToExcel").click(function (e) {
                            ...
                            if (table && table.length) {
                                $(table).table2excel({
                                    exclude: ".noExl",
                                    name: "Rapport des retraits du " + periode,
                                    filename: "rapport des retraits du " + periode + ".xls",
                                    fileext: ".xls",
                                    exclude_img: true,
                                    exclude_links: true,
                                    exclude_inputs: true,
