...
class HomeController extends Controller
{
    ...
    public function test(){   
        ...
        $reference = '34231230083254';
        $client = new Client();
        $url = $base_url_bmo."/operation?reference=".$reference;
        ...
        */
        ...
        $client = new Client();
        $url = $base_url_bmo."/operations-collect/cancel";
        
        $body = [
            "operation" => "OPATRCO20231230083234287700126"
        ];
