                ...
                <div class="modal-content">
                    ...
                    <form action="/partenaire/add" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Type du partenaire:</label>
                                <select name="type_partenaire" class="form-control select2bs4" style="width:100%">
                                    <option value="">Selectionner le type de partenaire</option>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" required class="form-control" name="code">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">4 derniers chiffres</label>
                                        <input type="text" autocomplete="off" required class="form-control" name="last">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
