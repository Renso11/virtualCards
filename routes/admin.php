...
Route::post('/service/client/delete/{id}', [App\Http\Controllers\AppController::class, 'serviceClientDelete'])->name('service.client.delete')->middleware('auth');
Route::post('/service/client/activate/{id}', [App\Http\Controllers\AppController::class, 'serviceClientActivate'])->name('service.client.activate')->middleware('auth');
Route::post('/service/client/desactivate/{id}', [App\Http\Controllers\AppController::class, 'serviceClientDesactivate'])->name('service.client.desactivate')->middleware('auth');    
