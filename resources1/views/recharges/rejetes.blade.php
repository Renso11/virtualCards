        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <h3 class="card-title">Liste des rechargements rejetés</h3>
                    </div>
                        ...
                        <table class="table table-bordered table-striped example1">
                            ...
                            <tbody>
                                @foreach ($recharges as $item)
                                        ...
                                        <td>                                                
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#motif-recharge-{{ $item->id }}"><i class="fa fa-eye"></i>&nbsp;&nbsp;Voir le motif du rejet</a>
                                                    @if (hasPermission('rechargement.rejetes.delete'))
                                    ...
                                    <div class="modal fade" id="motif-recharge-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="exampleModalLabel1">Motif du rejet</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                </div>
                                                <form action="/rechargements/delete/{{ $item->id }}" method="POST"> 
                                                    @csrf
                                                    <div class="modal-body">
                                                        <p>{{ $item->motif_rejet }}</p>
                                                    </div>
