                ...
                <div class="col-md-4">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <div class="row">
                                <button type="button" class="btn waves-effect waves-light btn-primary" data-toggle="modal" data-target="#add-partenaire">Recharger</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="/recharge/kkp" method="POST" id="form-recharge-kkp" enctype="multipart/form-data"> 
                        ...
                        <div class="modal-body">
                            <div class="form-group">  
                                ...
                                <input type="number" autocomplete="off" required class="form-control" name="montant" id="montant">
