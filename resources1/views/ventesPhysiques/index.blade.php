...
@endsection
@section('page')
    Commande de cartes physiques en attentes
@endsection
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <h3 class="card-title">Liste des commandes de cartes physiques en attentes</h3>
                        </div>
                                            ...
                                            <td>                                                
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        @endif
                                                        @if (hasPermission('vente.physiques.attentes.validation'))
                                                        ...
                                                        @endif
                                                        @if (hasPermission('vente.physiques.attentes.rejet'))
                                                        ...
                                                        @endif
                                                        @if (hasPermission('vente.physiques.delete'))
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/client/edit/{{ $item->id }}" method="POST"> 
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <a href="{{ $item->kycClient->piece_file }}" target="_blank">
                                                                        <img src="{{ asset($item->kycClient->piece_file) }}" width="40%" alt="Image du client">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <hr>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <label for="">Gamme commandée</label>
                                                                    <p>{{ $item->gamme->libelle }}</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label for="">Reference du paiement</label>
                                                                    <p>@if($item->reference) <span class="text-success">{{ $item->reference }}</span>@else <span class="text-danger">Pas de reference</span> @endif</p>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label for="">Montant payé</label>
                                                                    <p>{{ $item->montant }} F CFA</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" autocomplete="off" class="form-control" name="telephone" value="{{ $item->kycClient->telephone }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                        ...
                                        <div class="modal fade" id="del-vente-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/ventes/physiques/delete/{{ $item->id }}" method="POST"> 
                                                        @csrf
                                                        <div class="modal-body">
                                        ...
                                        <div class="modal fade" id="validation-vente-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/ventes/physiques/attentes/validation/{{ $item->id }}" method="POST"> 
                                                        @csrf
                                                        <div class="modal-body">
                                                            <p>Etes vous sur de valider cette commande? Une carte sera attribué au client qu'il viendra récupérer.</p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Non</button>
                                                            <button type="submit" class="btn btn-primary">Oui</button>
                                        ...
                                        <div class="modal fade" id="rejet-vente-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/ventes/physiques/attentes/rejet/{{ $item->id }}" method="POST"> 
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="form-group">
